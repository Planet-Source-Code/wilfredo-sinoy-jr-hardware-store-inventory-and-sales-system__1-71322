...
Begin VB.Form frmUndelivered 
   BackColor       =   &H00404040&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Undelivered Sales Information"
   ClientHeight    =   7725
   ClientLeft      =   2070
   ClientTop       =   1800
   ClientWidth     =   11025
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSDataListLib.DataCombo txtSearch 
         Bindings        =   "frmUndelivered.frx":0000
         Height          =   360
         Left            =   8040
         TabIndex        =   9
         Top             =   2160
   ...
   End
End
Attribute VB_Name = "frmUndelivered"
...
Call SQLDB2(Me.AdoSales, "Select * from Sales where DeliveryStatus ='" & "Undelivered" & "' order by SalesNumber")
Me.AdoSales.Refresh
settext
Call SQLDB5(Me.AdoSalesInfo, "Select * from SalesInfo where SalesNumber='" & Me.txtSalesNumber.Text & "'")
